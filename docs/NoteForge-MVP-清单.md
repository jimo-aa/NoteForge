...
| 编号 | 任务 | 状态 |
|:----:|------|:----:|
| 1.1 | Rust 项目骨架搭建 (Cargo workspace) | 📝 |
| 1.2 | Markdown 引擎：解析 pulldown-cmark → AST | 📝 |
| 1.3 | Markdown 引擎：Wiki Link [[...]] 解析 | 📝 |
| 1.4 | Markdown 引擎：HTML 渲染 | 📝 |
| 1.5 | 本地存储：SQLite 建表 + 笔记 CRUD | 📝 |
| 1.6 | 本地存储：笔记本/标签 CRUD | 📝 |
| 1.7 | 本地搜索：Tantivy 全文索引 | 📝 |
| 1.8 | FFI 接口：Tauri 命令绑定 | 📝 |

### Week 2：Tauri 桌面端

| 编号 | 任务 | 状态 |
|:----:|------|:----:|
| 2.1 | Tauri 项目创建 + React 集成 | 📝 |
| 2.2 | 基础 UI：侧边栏 + 笔记列表 + 编辑器 | 📝 |
| 2.3 | Markdown 编辑器 (CodeMirror 6) | 📝 |
| 2.4 | 笔记 CRUD 界面 | 📝 |
| 2.5 | 笔记本/标签管理界面 | 📝 |
| 2.6 | 全文搜索界面 | 📝 |
| 2.7 | 键盘快捷键 | 📝 |
...
| 3.2 | PostgreSQL 建表 + JPA 实体 | 📝 |
| 3.3 | 用户注册/登录 (JWT) | 📝 |
| 3.4 | 笔记 CRUD API | 📝 |
| 3.5 | 同步 API (pull/push) | 📝 |
| 3.6 | MinIO 文件上传 | 📝 |
| 3.7 | API 文档 (SpringDoc OpenAPI) | 📝 |
