...
const FILTERS = [
  { id: 'all', iconType: 'shoucang' as const, label: '收藏的笔记' },
...
export function Sidebar({ onNewNote, onNewNotebook }: SidebarProps) {
